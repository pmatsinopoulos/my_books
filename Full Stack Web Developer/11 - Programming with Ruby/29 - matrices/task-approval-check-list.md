Your student needs to implement the program as requested. Here is a sample implementation:
...
**Important:** Your student needs to send their work to their Github account.
