Your student needs to write the two versions of the program as per the task requirements. Here are two sample implementations:
...
**Important:** Your student needs to upload their work on their Github account. You will evaluate their work online.
